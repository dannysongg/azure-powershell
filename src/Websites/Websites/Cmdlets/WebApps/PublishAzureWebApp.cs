...
namespace Microsoft.Azure.Commands.WebApps.Cmdlets.WebApps
{
    ...
    public class PublishAzureWebAppCmdlet : WebAppOptionalSlotBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            {
                throw new Exception("Deployment type is mandatory when deploying from URLs. Use -type");
            }
            ...
            Action zipDeployAction = () =>
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    {
                        throw new Exception("Either ArchivePath or ArchiveURL should be provided.");
                    } 
